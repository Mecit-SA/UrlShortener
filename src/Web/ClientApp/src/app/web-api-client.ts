...
export interface IUrlsClient {
    getOriginalUrl(shortenedUrl: string): Observable<void>;
    shortenUrl(command: ShortenUrlCommand): Observable<string>;
}
...
export class UrlsClient implements IUrlsClient {
    ...
    getOriginalUrl(shortenedUrl: string): Observable<void> {
        let url_ = this.baseUrl + "/api/Urls/{shortenedUrl}";
        if (shortenedUrl === undefined || shortenedUrl === null)
            throw new Error("The parameter 'shortenedUrl' must be defined.");
        url_ = url_.replace("{shortenedUrl}", encodeURIComponent("" + shortenedUrl));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetOriginalUrl(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetOriginalUrl(response_ as any);
                } catch (e) {
    ...
    protected processGetOriginalUrl(response: HttpResponseBase): Observable<void> {
    ...
    shortenUrl(command: ShortenUrlCommand): Observable<string> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processShortenUrl(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processShortenUrl(response_ as any);
                } catch (e) {
    ...
    protected processShortenUrl(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class ShortenUrlCommand implements IShortenUrlCommand {
    ...
    static fromJS(data: any): ShortenUrlCommand {
        data = typeof data === 'object' ? data : {};
        let result = new ShortenUrlCommand();
        result.init(data);
        return result;
    }
